...
![Router Status Screenshot](/screenshots/ciscorouter0status.png)
  ...
  *Router status window showing interface and device information.*
...
![Switch Status Screenshot](/screenshots/ciscoswitch0status.png)
  ...
  *Switch status window showing device information.*
...
- Filenames match the exact screenshot names provided.  
- All images should remain in the `/screenshots` directory for consistency.  
- Additional VirtualBox or pfSense screenshots can be added later if needed.
